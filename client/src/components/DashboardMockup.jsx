...
const DashboardMockup = () => (
  <div className="relative rounded-2xl border border-white/10 bg-gray-950/80 p-4 shadow-2xl shadow-emerald-950/30">
    ...
    <div className="flex items-center justify-between border-b border-white/10 pb-4">
      <div>
        <p className="text-xs uppercase tracking-[0.2em] text-gray-500">Trader Dashboard</p>
    ...
    <div className="mt-4 rounded-xl border border-white/10 bg-white/[0.03] p-4">
      <div className="mb-4 flex items-center justify-between">
        ...
        <span className="text-xs text-gray-500">Last 30 trades</span>
      </div>
    ...
    <div className="mt-4 grid gap-3 md:grid-cols-2">
      <div className="rounded-xl border border-white/10 bg-white/[0.03] p-4">
        <p className="text-xs uppercase tracking-[0.18em] text-gray-500">Recent trade</p>
        <div className="mt-3 flex items-center justify-between">
          <div>
            <p className="font-bold text-white">GBPUSD Buy</p>
            <p className="text-sm text-gray-500">London session · FVG setup</p>
          </div>
      ...
      <div className="rounded-xl border border-dashed border-cyan-300/30 bg-cyan-300/5 p-4">
        ...
        <p className="text-sm text-gray-500">Before entry, entry, exit, and marked review.</p>
      </div>
    </div>

    <div className="mt-4 flex items-center gap-2 rounded-xl border border-white/10 bg-white/[0.03] p-3 text-sm text-gray-300">
