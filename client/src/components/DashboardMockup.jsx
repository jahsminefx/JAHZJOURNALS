  ...
  <div className="relative rounded-2xl border border-border bg-surface dark:border-white/10 dark:bg-background/80 p-4 shadow-xl dark:shadow-emerald-950/30">
    ...
    <div className="mt-4 grid gap-3 md:grid-cols-2">
      ...
      <div className="rounded-xl border border-dashed border-cyan-300/30 bg-cyan-300/5 p-4">
        ...
        <p className="mt-3 font-semibold text-foreground">Chart screenshot</p>
        <p className="text-sm text-muted">Before entry, entry, exit, and marked review.</p>
      </div>
    </div>

    <div className="mt-4 flex items-center gap-2 rounded-xl border border-border bg-surface-muted dark:border-white/10 dark:bg-white/[0.03] p-3 text-sm text-muted">
