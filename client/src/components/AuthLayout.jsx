      ...
      <div className="grid w-full overflow-hidden rounded-2xl border border-white/10 bg-white/[0.04] shadow-2xl lg:grid-cols-[1fr_0.9fr]">
        <div className="relative hidden overflow-hidden p-10 lg:flex lg:flex-col lg:justify-between">
          ...
          <div className="relative z-10">
            <p className="text-xs font-bold uppercase tracking-[0.24em] text-emerald-300">Structured review</p>
            <h2 className="mt-4 text-4xl font-black tracking-tight text-white">
              Review your trades. Refine your edge.
            </h2>
            <p className="mt-4 text-gray-300">
              Keep your journal, screenshots, emotions, and mistakes in one disciplined workflow.
            </p>
          </div>
          <p className="relative z-10 text-sm text-gray-400">Not a signal service. Built for better trading review.</p>
        </div>
