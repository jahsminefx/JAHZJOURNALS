...
const MentorMockup = () => (
  <div className="rounded-2xl border border-white/10 bg-gray-950/80 p-5 shadow-2xl shadow-emerald-950/20">
    <div>
      <p className="text-xs uppercase tracking-[0.2em] text-gray-500">Mentor Workspace</p>
